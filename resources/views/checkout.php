			...
			<form id="regForm"  action="" method="POST">
				...
				<div class="tab">Datos de tarjeta:
					<div class="card">
						...
						<input id="user" name="tarjeta" type="text" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" min="1" max="9999999999999999" class="input cardnumber" placeholder="1234 5678 9101 1121">
						<script>
						...
						<label>Nombre:</label>
						<input name="nombre" class="input name" placeholder="Edgar Pérez">
